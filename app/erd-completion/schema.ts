...
const attributeSchema = z.object({
    ...
    isPrimaryKey: z
        .boolean()
        .optional()
        .describe("Whether the attribute is a primary key."),
    isAutoIncrement: z
        .boolean()
        .optional()
        .describe("Whether the attribute is auto-incrementing."),
    isUnique: z
        .boolean()
        .optional()
    ...
    length: z
        .number()
        .optional()
        .describe("Length of the attribute, if applicable."),
    precision: z
        .number()
        .optional()
        .describe("Precision of the attribute, if applicable."),
    scale: z
        .number()
        .optional()
...
export const erdCompletionSchema = z.object({
    nodes: z
        .array(
            z.object({
    ...
    edges: z
        .array(
            z.object({
                ...
                references: z.object({
                    entity: z
                        .string()
                        .describe("Name of the referenced entity."),
                    attribute: z
                        .string()
        ...
        .describe("List of suggested relationships between entities.")
        .optional(),
});
